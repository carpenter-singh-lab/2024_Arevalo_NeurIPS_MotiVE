...
def bipartite_target_knn_baseline(results_path, output_path):
    ...
    for k in range(1, 11):
        ...
        gnn_score = classification_report(
            gnn["y_true"], gnn["y_pred"], output_dict=True
        )["True"]
        knn_score = classification_report(
            knn["y_true"], knn["y_pred"], output_dict=True
        )["True"]
        gnn_score.update(
            {
