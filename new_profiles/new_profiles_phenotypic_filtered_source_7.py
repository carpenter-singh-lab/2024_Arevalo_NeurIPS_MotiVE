...
df = df.query("Metadata_PlateType.isin(['ORF', 'CRISPR']) or Metadata_Source=='source_7'")
df.to_parquet("prof_source_7.parquet")

average_precision_negcon("prof_source_7.parquet", "ap_scores.parquet")
mean_average_precision("ap_scores.parquet", "map_scores.parquet", 0.1)
mscores = pd.read_parquet("map_scores.parquet")

df = pd.read_parquet("prof_source_7.parquet")
